...
public class CreatureTypeSeeder implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    creatureTypesList.add(Merfolk);

    if (creatureTypesRepository.count() == 0) {
